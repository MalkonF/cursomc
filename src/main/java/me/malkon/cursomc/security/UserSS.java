...
public class UserSS implements UserDetails {
	...
	public boolean isAccountNonExpired() {
		return true;/*
					 * aContaNEstaExpirada? true, a conta não está expirada. Aqui poderia ser
					 * implementado a lógica que diz que o usuário pode estar com a conta expirada
					 * Ex: Se algo acontecer, a conta esta expirada, entao retorna false
					 */
	}
