...
public interface ProdutoRepository extends JpaRepository<Produto, Integer> {
	// não é necessário fazer uma transação, somente consulta. Aqui consulta é feita
	// usando JPQL
	@Transactional(readOnly = true) // Em FROM Produto, produto tem que ser na forma q esta na classe
...
/*
 * @Param - vai pegar a variável e jogar na query com o mesmo nome da
 * consulta @Query
 * 
